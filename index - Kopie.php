...
<body id="top">
	<header>
        <?php
            session_start();
            if(isset($_POST['mitteilung']) && isset($_POST['email']) && isset($_POST['betreff']) && isset($_POST['name'])){
                $_SESSION['mitteilung'] = $_POST['mitteilung'];
                $_SESSION['email'] = $_POST['email'];
                $_SESSION['betreff'] = $_POST['betreff'];
                $_SESSION['name'] = $_POST['name'];
                Header('Location: https://baumgartner.wuermli-jeffry.ch'); 
            }
        ?>
    ...
    <div class="page-content">
        ...
        <?php
            ...
            if(isset($_SESSION['mitteilung']) && isset($_SESSION['email']) && isset($_SESSION['betreff']) && isset($_SESSION['name'])){
                ...
                if ($mail->send()) {
                    echo "<div id='senden' class='container cc-experience'>" .
                            "<div id='senden1' class='card'>" .
                            "<div class='bg-primary' data-aos='fade-right' data-aos-offset='50' data-aos-duration='500'>" .
                                "<div class='card-body cc-education-header'>" .
                                    "<p id='text-senden'>Vielen Dank für Ihr Feedback! Ihr Nachricht wurde erfolgreich übermittelt.</p>" .
                                "</div>" .                                            
                            "</div>" .
                        "</div></div>" ;
                    
                } 
				$_POST['mitteilung'] = null;
				$_POST['email'] = null;
				$_POST['betreff'] = null;
                $_POST['name'] = null;
            }
